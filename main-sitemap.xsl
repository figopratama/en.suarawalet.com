		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				<xsl:choose>
					...
					<xsl:otherwise>
						<title>XML Sitemap - Suara Walet</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>KML File</h1>
															...
															<p>
									This KML Fiile is generated by the <a href="https://s.rankmath.com/home" target="_blank">Rank Math WordPress SEO Plugin</a>. It is used to provide location information to Google.								</p>
							
							<p>
								Learn more about the <a href="https://developers.google.com/kml/documentation/" target="_blank">KML File</a>.							</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>XML Sitemap</h1>
															...
															<p>
									This XML Sitemap is generated by the <a href="https://s.rankmath.com/home" target="_blank">Rank Math WordPress SEO Plugin</a>. It is what search engines like Google use to crawl and recrawl posts/pages/products/images/archives on your website.								</p>
